...
if __name__ == '__main__':
    ...
    # test cases
    test_1: list[int] = [1, 2, 3, 5]  #output = 4
    test_2: list[int] = [100, 101, 103, 104, 105] #output = 102
    test_3: list[int] = [2000, 2001, 2002, 2003, 2004, 2005, 2007] #output = 2006
    test_4: list[int] = [-10, -9, -8, -7, -5, -4, -3, -2] #output = -6
    test_5: list[int] = [-2, -1, 1, 2, 3] #output = 0
    test_6: list[int] = [1, 2, 3, 4, 5, 6] #output  = 0
    
    test_cases: list[list[int]] = [test_1, test_2, test_3, test_4, test_5, test_6]
